...
def jogar():
    ...
    player = input("Digite o seu nome: ")
    ...
    for rodada in  range(1, total_de_tentativas + 1):
            ...
            if(acertou):
                print("Parabéns {}! Você acertou e fez {} pontos!".format(player ,pontos))
                break
            else:
                if(maior):
                    print(f"{player}! O seu chute foi maior do que o número secreto!")
                elif(menor):
                    print(f"{player}! O seu chute foi menor do que o número secreto!")
